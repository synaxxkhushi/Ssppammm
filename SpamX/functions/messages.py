...
start_message = """
**Hello {}, Your SynaxSpam - Assistant here!**
...
- Support: @{2}**
    ...
    basic = """
**Basic Commands of SynaxSpam**

 1) `{0}ping` - __to check ping.__
 2) `{0}alive` - __to check is SynaxSpam is alive.__
 3) `{0}reboot`- __to reboot/restart all SynaxSpam clients.__
...
**Profile Commands of SynaxSpam**
 ...
 4) `{0}setall` | `{0}updateall` (new name) - __using this command SynaxSpam will update name of users in sequence. [e.g #1 SynaxSpam]__
...
**#NOTE: Owner can enable raids on anyone (including sudos) & sudo with high rank can enable raid on lower rank sudos & for more info join @{1} & ask!**
    ...
    direct_message = """
**Direct Message (DM) Commands of SynaxSpam**
